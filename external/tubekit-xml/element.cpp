...
tubekit::xml::element::iterator element::begin()
{
    return m_children.begin();
}

tubekit::xml::element::iterator element::end()
{
    return m_children.end();
}

tubekit::xml::element::const_iterator element::cbegin() const
{
    return m_children.cbegin();
}

tubekit::xml::element::const_iterator element::cend() const
{
