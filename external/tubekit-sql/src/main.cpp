...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        tubekit::sql::result<0> m_update_result;
        ...
        tubekit::sql::result<0> m_delete_result;
        ...
        tubekit::sql::result<0> m_11_result;
        ...
        tubekit::sql::result<0> m_insert_result;
